...
export const alchemyResources = {
  ...
  "cardinality": {
    ...
    effect: amount => Decimal.div(0.2, amount.div(12500).add(1)).add(1),
    tier: 2,
    uiOrder: 3,
    unlockedAt: 8,
  ...
  "eternity": {
    ...
    symbol: "τ",
    isBaseResource: false,
    effect: amount => amount.div(12500).add(1),
    tier: 2,
    uiOrder: 2,
    unlockedAt: 9,
  ...
  "dimensionality": {
    ...
    symbol: "ρ",
    isBaseResource: false,
    effect: amount => Decimal.pow10(amount.times(6)),
    tier: 2,
    uiOrder: 1,
    unlockedAt: 10,
  ...
  "alternation": {
    ...
    symbol: "ω",
    isBaseResource: false,
    effect: amount => amount.div(125000),
    tier: 2,
    uiOrder: 4,
    unlockedAt: 12,
  ...
  "effarig": {
    ...
    symbol: "Ϙ",
    isBaseResource: true,
    effect: amount => Math.pow(10, amount.div(1250)),
    tier: 1,
    uiOrder: 1.5,
    unlockedAt: 7,
  ...
  "synergism": {
    ...
    isBaseResource: false,
    effect: amount => {
      const rawValue = Decimal.sqrt(amount.div(25000)).mul(1.7).add(0.3);
  ...
  "momentum": {
    ...
    symbol: "μ",
    isBaseResource: false,
    effect: amount => amount.div(100000).add(1),
    tier: 3,
    uiOrder: 3,
    unlockedAt: 15,
  ...
  "decoherence": {
    ...
    symbol: "ξ",
    isBaseResource: false,
   effect: amount => Decimal.sqrt(amount.div(25000)).mul(0.2),
    tier: 3,
    uiOrder: 4,
    unlockedAt: 14,
  ...
  "exponential": {
    ...
    symbol: "Γ",
    isBaseResource: false,
    effect: amount => Decimal.pow(amount.div(10000), 33).mul(10),
    tier: 4,
    uiOrder: 2,
    unlockedAt: 18,
  ...
  "uncountability": {
    ...
    symbol: "Θ",
    isBaseResource: false,
    effect: amount => Decimal.sqrt(amount.div(6250)).mul(1600),
    tier: 4,
    uiOrder: 3,
    unlockedAt: 19,
  ...
  "boundless": {
    ...
    symbol: "Π",
    isBaseResource: false,
    effect: amount => amount.div(62500),
    tier: 4,
    uiOrder: 1,
    unlockedAt: 20,
  ...
  "multiversal": {
    ...
    symbol: "Σ",
    isBaseResource: false,
    effect: amount => Decimal.pow(amount.div(20000), 2).mul(32),
    tier: 4,
    tier: 4,
    uiOrder: 5,
    unlockedAt: 16,
